        ...
        <div className="relative z-10 flex flex-col items-center text-center space-y-10">
          <div className="space-y-4">
            ...
            <h2 className="text-5xl md:text-7xl font-bold tracking-tighter text-black dark:text-white leading-none">
              Let's build <span className="text-black dark:text-white italic">it.</span>
            </h2>
            <p className="text-gray-500 dark:text-gray-400 max-w-sm mx-auto text-sm md:text-base font-light">
