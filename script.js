...
const projectCards = document.querySelectorAll('.project1, .techContainer');
...
document.addEventListener('DOMContentLoaded', function () {
    var navTimeline = gsap.timeline({ defaults: { ease: "power2.out" } });

    // Logo animation - simple fade in from Y
    ...
    // Navigation items - simple fade in from Y with stagger
    ...
    // Toggle button icons - simple fade in from Y
